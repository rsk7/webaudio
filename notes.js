var noteProvider = new (function(){
	...
	var note_list = [
		...
		{'name' : 'C# / Db', 'octave' :	 8, 'frequency' :	 4434.922},
		{'name' : 'D', 'octave' :	 8, 'frequency' :	 4698.636},
		{'name' : 'D# / Eb', 'octave' :	 8, 'frequency' :	 4978.032},
		...
		{'name' : 'G# / Ab', 'octave' :	 8, 'frequency' :	 6644.876},
		...
		{'name' : 'C# / Db', 'octave' :	 9, 'frequency' :	 8869.844},
		{'name' : 'D', 'octave' :	 9, 'frequency' :	 9397.272},
		{'name' : 'D# / Eb', 'octave' :	 9, 'frequency' :	 9956.064},
		{'name' : 'E', 'octave' :	 9, 'frequency' :	 10548.084},
		{'name' : 'F', 'octave' :	 9, 'frequency' :	 11175.304},
		{'name' : 'F# / Gb', 'octave' :	 9, 'frequency' :	 11839.82},
		{'name' : 'G', 'octave' :	 9, 'frequency' :	 12543.856},
		{'name' : 'G# / Ab', 'octave' :	 9, 'frequency' :	 13289.752},
		{'name' : 'A', 'octave' :	 9, 'frequency' :	 14080	 }	  ,
		{'name' : 'A# / Bb', 'octave' :	 9, 'frequency' :	 14917.24},
		{'name' : 'B', 'octave' :	 9, 'frequency' :	 15804.264}
	];

	this.get = function(data) {
		return _.findWhere(note_list, data);
	};

	this.getNote = function(noteName, octave) {
		return _.find(note_list, function(note) {

			if(noteName.length === 1) {
				return note.name === noteName.toUpperCase() &&
					note.octave === octave;
			}

			return note.name.length > 1 &&
				note.name.indexOf(noteName.toUpperCase()) !== -1 && 
				note.octave === octave;
